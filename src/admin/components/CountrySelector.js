...
const CountrySelector = ({
    ...
    return (
        <div className={`relative country-dropdown-container country-dropdown-container-${instanceId}`}>
            ...
            <div
                className="min-h-[40px] w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm bg-white cursor-text flex flex-wrap items-center gap-2 focus-within:ring-2 focus-within:ring-green-500 focus-within:border-green-500"
                onClick={() => {
